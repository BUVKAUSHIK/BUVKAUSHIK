...
|---|---|---|
| **[AEO Pre-Publish Scorer](https://github.com/BUVKAUSHIK/AEO)** | Scores whether a webpage is ready for AI/answer-engine discovery using page extraction, rule-based checks, and LLM judgment. | Moves content teams from “publish and wait” to pre-launch decision-making. |
...
| **[HarvestIQ](https://github.com/BUVKAUSHIK/HarvestIQ)** | County-level corn and soybean yield forecasting using NOAA weather data, USDA yield data, PySpark, XGBoost quantile regression, Delta tables, and MLflow. | Turns weather volatility into early-warning agricultural risk signals. |
| **[DoorDash Table Mode](https://github.com/BUVKAUSHIK/doordash-table-mode)** | Product prototype for dine-in group ordering, QR-based table joining, receipt upload, split allocation, retries, and edge states. | Shows how a consumer workflow can be mapped from user friction to product states. |
| **[FinOps Checkout Analytics](https://github.com/BUVKAUSHIK/e-commerce-app-design)** | Privacy-first checkout analytics using PostHog, Stripe webhooks, experiments, session replay, and Vercel deployment. | Connects product instrumentation to conversion, payment truth, and experimentation. |
| **[Washington State PCO Guide](https://github.com/BUVKAUSHIK/Capstone)** | Accessible civic education site for young Washington voters learning about Precinct Committee Officers. | Makes local civic participation easier to understand for first-time and younger voters. |
| **[Churn Navigator](https://github.com/BUVKAUSHIK/Churn_Navigator)** | Churn prediction and engagement system using MongoDB, Spark, Airflow, FastAPI, Docker, Kubernetes, and n8n automation. | Demonstrates an end-to-end data-to-action retention workflow. |
| **[EcoPulse](https://github.com/BUVKAUSHIK/EcoPulse)** | Carbon footprint tracking app for employees with goals, recommendations, charts, and progress tracking. | Applies product design and data visibility to sustainability behavior change. |
...
[LinkedIn](https://www.linkedin.com/in/b-u-v-k/) · [Portfolio](https://plant-sovereign-c5a.notion.site/uvabolla) · [Substack](https://substack.com/@uvabolla) · [Email](mailto:buvkaushik55@gmail.com)
